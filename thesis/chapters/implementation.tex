...
One major problem of the diagonal method is that it requires so many Galois rotations of the input vector, which causes a large error after too many consecutive rotations (\cref{fig:rotation-error}).
