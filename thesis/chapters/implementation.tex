...
\begin{enumerate}
  \item Scale (retrieved using \mintinline{cpp}{x.scale()})
        \begin{quote}
  ...
  \item Encryption Parameters (retrieved using \mintinline{cpp}{x.parms_id()})
  \item Ciphertext Size (retrieved using \mintinline{cpp}{x.size()})
\end{enumerate}
