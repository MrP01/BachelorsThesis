...
A web-based demonstrator to show how to classify handwritten digits when using \glslink{he}{homomorphic encryption} was implemented, comprised of a C++ server and a React\footnote{https://reactjs.org/} frontend, confer \autoref{fig:frontend}.
