...
The resulting scheme, referred to as \gls{bgv}, allows for integer arithmetic. It also employs a modulus reduction technique, greatly extending the homomorphic capacity to a broader class of homomorphic circuits.
