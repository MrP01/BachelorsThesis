...
\footnote{Many implementations of \gls{bfv} provide similar encoding and decoding procedures, extending the original BFV scheme \parencite{2012-fv-original}.}.
...
\begin{table}[H]
  ...
  \begin{tblr}{rll}
    ...
    $\vec{\gamma}$ & $\in (R/(P \cdot q_L)R)^2$ & Relinearization Key \\
