...
from the original goal of introducing basic \gls{he} operations, this short section aims to motivate
...
The following discussion of the homomorphic encryption schemes requires some mathematical basics.

\paragraph{The $n$-th roots of unity}
