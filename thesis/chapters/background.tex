...
\begin{definition}{Integers modulo $t$: $\Z / t \Z$}{integers-modulo-t}
  Using equivalence classes $\overline{x}_t$ modulo $t$, define the commutative quotient ring of integers modulo $t$ as
...
\begin{definition}{Cyclotomic Polynomial}{cyclotomic-poly}
  Given the $n$-th roots of unity $\{x_k\}$, we can define the $n$-th cyclotomic polynomial as
