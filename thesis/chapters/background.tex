...
% Roman: maybe mention here, that in LWE based cryptosystems, the public key is m LWE samples, i.e., (A, b) where A is a m x m matrix and b a m vector. For RLWE it is then just (a,b) where a and b have b coefficients. Hence, keys are smaller in RLWE.
