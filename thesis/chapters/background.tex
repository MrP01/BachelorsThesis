...
Neural networks used today are very similar in their structure (cf. \autoref{fig:neural-network}).
...
For more details on the implemented neural networks' structure, code and performance, refer to \autoref{chap:implementation} and \autoref{chap:results}.
...
Function spaces are a widely useful concept, polynomial rings are a great example too (confer \autoref{corollary:bounded-polynomials-mod-q}).
...
This seemingly simple system is referred to as a \textit{Qubit}, the basic unit of quantum information theory.
