...
\tikzset{arrowed/.style={decorate,
      decoration={show path construction,
          moveto code={},
          lineto code={
              \draw[#1, black, line width=3pt] (\tikzinputsegmentfirst) --  (\tikzinputsegmentlast);
            },
          curveto code={},
          closepath code={},
        }},arrowed/.default={-stealth}}
\pgfplotsset{gradient function/.initial=f,dx/.initial=0.01,dy/.initial=0.01}
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot3[mesh,shader=interp,domain=-4:4,samples=50]{f(x,y)};
